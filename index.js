...
不要重复已有内容，不要输出书名和文案。`;
        ...
        let styleText = '';
        if (style) {
            const styleMap = { sweet: '甜宠', heart: '虐心', suspense: '悬疑', relax: '轻松', passion: '热血' };
            styleText = `风格要求：${styleMap[style] || style}风格。`;
        }
