...
function renderCustomPageContent(page) {
    ...
    // 添加删除页面的按钮
    const deleteBtnHtml = `
        <div class="delete-page-container" style="margin-top: 16px; text-align: center;">
            <button id="delete_page_${page.id}" class="delete-page-btn" style="background: #d32f2f; color: white;">删除此页面</button>
        </div>
    `;
...
.panel-header { display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; border-bottom: 1px solid #e0e0e0; font-weight: 500; background: #f8f8f8; }
...
.delete-page-btn { padding: 6px 12px; border-radius: 8px; cursor: pointer; }
