...
// 包含：角色卡、用户人设、批量生成、世界书、世界扩展、关系网、魔法衣橱、故事生成器、玩法生成器、小说生成器、小剧场、心理学分析(含MBTI)、文风生成、预设生成、自定义页面管理器
    ...
    let html = `
        <div class="custom-page-editor">
            ...
            <div class="custom-page-list">
                ...
                <div class="reset-default-container" style="margin-top: 16px;">
                    <button id="reset-custom-pages-default" class="reset-btn">恢复默认自定义页面</button>
                </div>
            </div>
        </div>
    `;
...
function refreshCustomPagesUI() {
    ...
    const resetDefaultBtn = document.getElementById('reset-custom-pages-default');
    if (resetDefaultBtn) {
        resetDefaultBtn.onclick = () => {
            if (confirm('恢复默认自定义页面？这将删除所有你创建的自定义页面！')) {
                customPages = [];
                saveCustomPages();
                refreshCustomPagesUI();
                rebuildTabs();
