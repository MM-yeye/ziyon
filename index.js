    ...
    return `
        <div class="template-editor-grid">
            <div class="grid-col">
                ...
                <div class="template-card">
                    <h4>心理分析提示词</h4>
                    <textarea id="edit-psychology-analysis" rows="6" style="width:100%; font-family: monospace; font-size: 12px;">${escapeHtml(psychologyTemplates.analysisPrompt)}</textarea>
...
<textarea id="psychology-result" class="result-text" rows="16" readonly></textarea></div>
